...
<html lang="en">
  <head>
    ...
    <title>Hello DevOps Students of RMIT Vietnam!!! I'm testing the docker build 2nd try</title>
  </head>
  <body>

    <!-- The content of the website starts here now! -->
    <div class="jumbotron">
      <h1 class="display-4">Hello DevOps Students of RMIT Vietnam!!! I'm testing the docker build</h1>
      ...
      <span>This is a test commit to test the github webhook</span>
    </div>
